        ...
        <div className="fixed h-[65px] transition-[margin] duration-100 xl:ml-[275px] group-[.side-menu--collapsed]:xl:ml-[90px] mt-3.5 inset-x-0 top-0">
          ...
          >
            <div className="flex items-center w-full h-full px-5">
              ...
              <Breadcrumb light className="flex-1 hidden xl:block text-slate-500">
                {breadcrumbItems.map((item: { label: string; path: string }, index: number) => {
                  ...
                  if (isFirst) {
                    return (
                      <Breadcrumb.Link
                        key={index}
                        className="dark:before:bg-chevron-white text-slate-500"
                        to={item.path}
                      >
                        {item.label}
                      </Breadcrumb.Link>
                  ...
                  if (isLast) {
                    return (
                      <Breadcrumb.Link
                        key={index}
                        className="dark:before:bg-chevron-white text-slate-200"
                        to={item.path}
                        active={true}
                      >
                        {item.label}
